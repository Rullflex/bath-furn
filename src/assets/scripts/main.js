...
document.addEventListener(`DOMContentLoaded`, function () {
    ...
    document.querySelector(`#video`).addEventListener(`inview`, (event) => {
        // document.querySelector(`#video .popup__body`).insertAdjacentHTML(`beforeend`, `<iframe class="embed-responsive-item" src="https://www.youtube-nocookie.com/embed/lpGr5OuS4mg" frameborder="0" allowfullscreen="true" data-uk-video data-uk-responsive"></iframe>`)
